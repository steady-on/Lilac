...
final class ChannelServiceImpl: ChannelService {
    ...
    func create(workspaceId: Int, name: String, description: String) -> RxSwift.Single<Result<Responder.Channel.Channel, Error>> {
    ...
    func loadAll(workspaceId: Int) -> RxSwift.Single<Result<[Responder.Channel.Channel], Error>> {
        return repository.request(.loadAll(workspaceId: workspaceId), responder: [Responder.Channel.Channel].self)
    }
    
    func loadBelongTo(workspaceId: Int) -> RxSwift.Single<Result<[Responder.Channel.Channel], Error>> {
        return repository.request(.loadBelongTo(workspaceId: workspaceId), responder: [Responder.Channel.Channel].self)
    }
    
    func load(workspaceId: Int, channelName: String) -> RxSwift.Single<Result<Responder.Channel.Channel, Error>> {
        return repository.request(.load(workspaceId: workspaceId, channelName: channelName), responder: Responder.Channel.Channel.self)
    }
    
    func update(workspaceId: Int, channelName: String, name: String?, description: String?) -> RxSwift.Single<Result<Responder.Channel.Channel, Error>> {
    ...
    func delete(workspaceId: Int, channelName: String) -> RxSwift.Single<Result<Void, Error>> {
        return repository.request(.delete(workspaceId: workspaceId, channelName: channelName))
    }
    
    func sendChatting(workspaceId: Int, channelName: String, content: Data?, files: [Data]?) -> RxSwift.Single<Result<Responder.Channel.Chatting, Error>> {
    ...
    func loadChatting(workspaceId: Int, channelName: String, cursorDate: String?) -> RxSwift.Single<Result<[Responder.Channel.Chatting], Error>> {
    ...
    func countUnreads(workspaceId: Int, channelName: String, after: String?) -> RxSwift.Single<Result<Responder.Channel.CountOfUnread, Error>> {
    ...
    func loadAllMembers(workspaceId: Int, channelName: String) -> RxSwift.Single<Result<[Responder.Channel.Member], Error>> {
        return repository.request(.member(workspaceId: workspaceId, channelName: channelName), responder: [Responder.Channel.Member].self)
    }
    
    func leave(workspaceId: Int, channelName: String) -> RxSwift.Single<Result<[Responder.Channel.Channel], Error>> {
        return repository.request(.leave(workspaceId: workspaceId, channelName: channelName), responder: [Responder.Channel.Channel].self)
    }
    
    func changeAdmin(workspaceId: Int, channelName: String, userId: Int) -> RxSwift.Single<Result<Responder.Channel.Channel, Error>> {
